...
const Footer = () => {
  return (
    <div className="px-10 border-t-[1px] border-t-blue-300 border-opacity-20 ">
      ...
      <section className="leading-[70px] mb-5">
        <div className="flex items-center gap-x-2">
          <a
            href="https://github.com/subhamBharadwaz"
            target="_blank"
            rel="noreferrer"
          ...
          <div className="h-7 border-l border-muted-foreground/50 opacity-50"></div>
          <a
            href="https://twitter.com/webhashira"
            target="_blank"
            rel="noreferrer"
            className="rounded-md p-2 transition-colors hover:bg-foreground/20 active:bg-foreground/30"
          >
          ...
          <div className="h-7 border-l border-muted-foreground/50 opacity-50"></div>
          <a
            href="https://www.linkedin.com/in/ayush-paul-05405b1b8/"
            target="_blank"
            rel="noreferrer"
            className="rounded-md p-2 transition-colors hover:bg-foreground/20 active:bg-foreground/30"
          >
      ...
      <div className="leading-[80px] text-sm text-blue-200 opacity-50">
